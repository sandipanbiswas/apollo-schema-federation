...
public class ProductService {
    ...
    public ProductService() {
        ...
        reviews.add(new Review("1","Love it!", new User("1"), new Product("1"), "test"));
        reviews.add(new Review("2","Too expensive.", new User("1"), new Product("2"), "test"));
        reviews.add(new Review("3","Could be better.", new User("2"), new Product("3"), "test"));
        reviews.add(new Review("4","Prefer something else.", new User("2"), new Product("1"), "test"));
    }
